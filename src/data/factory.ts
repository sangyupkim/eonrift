...
export const BUILDINGS: Record<BuildingType, BuildingDef> = {
  ...
  smelter: { type: 'smelter', name: '제련로', power: 6, color: 0xc0583a, cost: { copper_ore: 5 }, description: '광석을 주괴로 만든다.', blueprint: null },
  crusher: { type: 'crusher', name: '분쇄기', power: 5, color: 0x8a8f99, cost: { copper_ore: 4, wood: 2 }, description: '결정과 목재를 가루·판자로 만든다.', blueprint: { gold: 300, items: { copper_ingot: 3 } } },
...
export const RECIPES: Recipe[] = [
  ...
  { id: 'diamond', machine: 'crusher', inputs: { diamond_ore: 1 }, output: 'diamond', count: 1, time: 35 },
  ...
  { id: 'stone_low', machine: 'assembler', inputs: { mana_iron: 1, plank: 2 }, output: 'stone_low', count: 1, time: 45 },
  { id: 'stone_mid', machine: 'assembler', inputs: { mana_gold: 1, diamond: 1, frost_dust: 1 }, output: 'stone_mid', count: 1, time: 60 },
  { id: 'stone_high', machine: 'assembler', inputs: { mana_titanium: 1, orichalcum_ingot: 1, fire_dust: 1 }, output: 'stone_high', count: 1, time: 90 },
  ...
  { id: 'resonator', machine: 'assembler', inputs: { dim_dust: 3, dim_ingot: 2, orichalcum_ingot: 1, mana_titanium: 2 }, output: 'resonator', count: 1, time: 300 },
