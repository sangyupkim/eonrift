...
const defs: ItemDef[] = [
  ...
  { id: 'plank', name: '판자', color: 0xc99a62, kind: 'processed', value: 2, description: '벌목소에서 나무를 켜서 만든다. 판 합성과 제작의 재료.' },
  // 판: 주괴 + 판자를 제작대에서 합성. 같은 재질 장비·도구를 강화할 때 쓴다
  { id: 'copper_plate', name: '구리판', color: 0xe08a50, kind: 'processed', value: 30, description: '구리 장비·도구 강화 재료 (제작대 합성).' },
  { id: 'iron_plate', name: '철판', color: 0xb0b8c4, kind: 'processed', value: 45, description: '철 장비·도구 강화 재료 (제작대 합성).' },
  { id: 'gold_plate', name: '황금판', color: 0xffd35a, kind: 'processed', value: 75, description: '황금 장비·도구 강화 재료 (제작대 합성).' },
  { id: 'diamond_plate', name: '다이아판', color: 0xcff8ff, kind: 'processed', value: 115, description: '다이아 장비·도구 강화 재료 (제작대 합성).' },
  { id: 'titanium_plate', name: '티타늄판', color: 0xb8c4d4, kind: 'processed', value: 160, description: '티타늄 장비·도구 강화 재료 (제작대 합성).' },
  { id: 'orichalcum_plate', name: '오리하르콘판', color: 0xff9a5a, kind: 'processed', value: 220, description: '오리하르콘 장비·도구 강화 재료 (제작대 합성).' },
  { id: 'dim_plate', name: '차원판', color: 0x8a7cff, kind: 'processed', value: 300, description: '차원 장비·도구 강화 재료 (제작대 합성).' },
