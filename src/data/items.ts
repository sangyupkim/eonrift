...
const defs: ItemDef[] = [
  ...
  { id: 'food_luck', name: '수정 꿀차', color: 0xd0a8ff, kind: 'consumable', value: 80, description: '먹으면 30분 동안 골드 획득 +25%. 연금 솥: 수정나무 판자 2 + 참나무 판자 2 + 하급 정수 1.' },
  { id: 'food_exp', name: '철목 스튜', color: 0xa0a0aa, kind: 'consumable', value: 100, description: '먹으면 30분 동안 경험치 +20%. 연금 솥: 철목 판자 2 + 적송 판자 2 + 중급 정수 1.' },
  // 가공품
  ...
  { id: 'potion', name: '치유 물약', color: 0xff5a7a, kind: 'consumable', value: 15, description: '던전에서 HP 30%와 MP 30%를 회복한다. 상점에서 판다.' },
  ...
  { id: 'set_blueprint', name: '세트 설계도', color: 0xffb04a, kind: 'key', value: 0, description: '세트 장비를 만드는 설계도. 차원집 제작대의 세트 탭에서 직업과 부위를 골라 만든다 (그 직업의 공격형·방어형·균형형 세트 중 하나가 무작위로 나온다). ???에게서 증표로 바꾸거나 8장·레이드 보스에게서 얻는다.' },
